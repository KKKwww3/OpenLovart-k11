        ...
        <div className="flex-1 overflow-y-auto">
                          ...
                          <div className="flex items-start gap-3">
                            <div className="shrink-0 pt-0.5">
                              {notification.isPinned ? (
                                <span className="inline-block px-1.5 py-0.5 bg-orange-400 text-white rounded text-xs font-medium">
                                  置顶
                                </span>
                              ) : notification.isNew ? (
          ...
          <div className="px-8 py-12">
            ...
            <div className="max-w-3xl mx-auto text-center mb-16">
              ...
              >
                <span className="px-2 py-0.5 bg-orange-400 text-white rounded text-xs font-medium">
                  NEW
                </span>

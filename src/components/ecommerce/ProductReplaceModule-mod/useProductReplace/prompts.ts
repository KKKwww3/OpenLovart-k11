...
export const COMPOSE_PROMPT =
  "【核心任务】将设计图的图案精准应用到产品白底图的产品表面，生成一张完整的成品产品图。\n\n【参考图说明】\n- 产品白底图：提供产品的准确形状、材质质感（绒面、纤维密度、光泽度等）和锁边工艺（锁边颜色、纹理、厚度等），必须以此图的形状、材质和锁边为准\n- 设计图：仅提供图案和纹理信息，需要将其完整应用到产品表面\n\n【具体要求】\n1. 产品形状、大小、比例必须与产品白底图完全一致\n2. 产品的材质质感必须与产品白底图一致（绒面蓬松度、纤维密度、表面纹理、光泽度等）\n3. 产品的锁边效果必须与产品白底图一致（锁边颜色、纹理、厚度等）\n4. 图案/纹样/配色严格按照设计图进行替换，100% 还原设计图的图案\n5. 图案要自然融入产品表面，纹理走向和透视要正确\n6. 背景保持纯白色，不添加任何多余元素\n\n【画质要求】8K 超高清，商业产品摄影级画质，图案清晰锐利，与设计图色彩一致，材质和锁边与产品白底图一致，禁止图案模糊、走形、裁切或遗漏";

...
export const APPLY_PROMPT =
  "【核心任务】将设计图的图案精准应用到场景图中的产品表面，仅替换产品表面的图案/纹理，保持产品的形状、材质、锁边、厚度等所有物理特征完全不变。\n\n【参考图说明】\n- 场景图：场景中的产品已经包含了材质和锁边等完整细节，需要保留产品的外形轮廓、材质质感、锁边效果、阴影和厚度感\n- 设计图：仅提供图案和纹理信息，需要将其应用到场景中的产品表面\n\n【具体要求】\n1. 仅改变产品表面的图案/纹样/配色，严格按照设计图的图案进行替换\n2. 保持产品在场景中的位置、大小、角度不变\n3. 保持产品的材质质感（如绒面、纤维密度、光泽度等）不变\n4. 保持产品的锁边效果（锁边颜色、纹理、厚度等）不变\n5. 保持产品的形状和厚度不变，不要产生变形或扭曲\n6. 保持场景中的光影效果一致，图案要自然融入产品表面\n7. 背景和其他场景元素完全保持不变\n\n【画质要求】8K 超高清，商业产品摄影级画质，图案清晰锐利，与设计图色彩一致，禁止图案模糊、走形、裁切或遗漏";
